...
* Fix dependency specifications by ensuring `hex.build` and `hex.publish` jobs only see production dependencies. See https://github.com/kipcole9/money/issues/142 for explanation.
